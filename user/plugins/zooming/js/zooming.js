!function (t, e) {
    ...
    "use strict";
    var t = "auto", n = "zoom-in", o = "zoom-out", r = "grab", a = "move";
    ...
    var e = function () {
        ...
        init: function (t) {
            ...
            document.querySelector(".carousel").setAttribute("style", "overflow:visible");
            ...
            var t = document.documentElement || document.body.parentNode || document.body,
                e = window.pageXOffset || t.scrollLeft, i = window.pageYOffset || t.scrollTop;
            null === this.lastScrollPosition && (this.lastScrollPosition = {x: e, y: i});
            var n = this.lastScrollPosition.x - e, s = this.lastScrollPosition.y - i, o = this.options.scrollThreshold;
            ...
            t.preventDefault();
            var e = t.touches[0], i = e.clientX, n = e.clientY;
            this.pressTimer = setTimeout(function () {
                this.grab(i, n)
            }.bind(this), 200)
    ...
    var p = {
        ...
        init: function (t, e) {
            ...
            var t = this.instance.options, e = t.zIndex, i = t.enableGrab, n = t.transitionDuration,
            ...
            this.el.offsetWidth, c(this.el, {transform: "none"})
        }, grab: function (t, e, i) {
            var n = b(), s = n.x - t, o = n.y - e;
            c(this.el, {
                cursor: a,
            ...
            var t = b(), e = this.rect.left + this.rect.width / 2, i = this.rect.top + this.rect.height / 2;
            return {x: t.x - e, y: t.y - i}
        }, calculateScale: function () {
            var t = this.el.dataset, e = t.zoomingHeight, i = t.zoomingWidth, n = this.instance.options,
                s = n.customSize, o = n.scaleBase;
            ...
            var r = this.rect.width / 2, a = this.rect.height / 2, l = b(), h = (l.x - r) / r, c = (l.y - a) / a,
                u = o + Math.min(h, c);
            if (s && "string" == typeof s) {
                var d = i || this.el.naturalWidth, f = e || this.el.naturalHeight,
                    p = parseFloat(s) * d / (100 * this.rect.width), y = parseFloat(s) * f / (100 * this.rect.height);
    ...
    return function () {
        ...
        return y(e, [{
            key: "listen", value: function (t) {
                if ("string" == typeof t) for (var e = document.querySelectorAll(t), i = e.length; i--;) this.listen(e[i]); else "IMG" === t.tagName && (t.style.cursor = n, l(t, "click", this.handler.click), this.options.preloadImage && h(s(t)));
                return this
            }
        }, {
            ...
            key: "open", value: function (t) {
                var e = this, i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : this.options.onOpen;
            ...
            key: "close", value: function () {
                var e = this, i = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : this.options.onClose;
